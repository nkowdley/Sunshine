...
public class ForecastFragment extends Fragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            new FetchWeatherTask().execute("20151");
            return true;
        }
    ...
    public class FetchWeatherTask extends AsyncTask<String,Void,String[]>
    {
        ...
        protected String[] doInBackground(String... params) {
            ...
            try {
                ...
                int days=7; //making days its own variable for consistency
                Uri.Builder weatherURL=new Uri.Builder();
                weatherURL.scheme("http");
                weatherURL.authority("api.openweathermap.org");
                weatherURL.appendPath("data");
                weatherURL.appendPath("2.5");
                weatherURL.appendPath("forecast");
                weatherURL.appendPath("daily");
                weatherURL.appendQueryParameter("q", params[0]);
                weatherURL.appendQueryParameter("mode","json");
                weatherURL.appendQueryParameter("units","metric");
                weatherURL.appendQueryParameter("cnt", String.valueOf(days));
                Log.v(LOG_TAG, weatherURL.toString());
            ...
            try
            {
                String[] weatherDataArray = getWeatherDataFromJson(forecastJsonStr, 7);
                return weatherDataArray;
            }catch (JSONException e)
            {
                Log.e(LOG_TAG,"Json conversion to string array failed");
            }
